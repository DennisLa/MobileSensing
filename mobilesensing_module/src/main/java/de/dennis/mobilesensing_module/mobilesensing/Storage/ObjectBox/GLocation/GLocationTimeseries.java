...
//        timestamp_day = g.get(GregorianCalendar.YEAR)+"-"+(g.get(GregorianCalendar.MONTH)+1)+"-"+g.get(GregorianCalendar.DAY_OF_MONTH)+"T"+"00:00:00.000Z";
        timestamp_day = g.get(GregorianCalendar.YEAR)+"-"+(g.get(GregorianCalendar.MONTH)+1)+"-"+g.get(GregorianCalendar.DAY_OF_MONTH)+
                "T"+ g.get(GregorianCalendar.HOUR_OF_DAY) + ".000Z";
        uploaded = false;
    }
    ...
    public GLocationTimeseries(long timestamp, String timestamp_day, boolean uploaded) {
        this.timestamp = timestamp;
    ...
    public ToMany<GLocationsObject> getValues() {
        return values;
    }

    public void setValues(ToMany<GLocationsObject> values) {
        this.values = values;
    }
